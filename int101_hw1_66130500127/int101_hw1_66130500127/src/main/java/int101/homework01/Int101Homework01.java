...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
      ...
      */
      System.out.println("BMI of weight 85.5 kg and height 1.8 m is "+MyUtil.calculateBMI(85.5, 1.8));
      System.out.println("Average of 1, 5 and 9 is "+MyUtil.average(1, 5, 9));
   }
   ...
   static void work04UseOfObjectClass() {
      ...
      */
      ...
      BankAccount bankAccount1 = new BankAccount(1, person1);
      BankAccount bankAccount2 = new BankAccount(2, person2);
      ...
      System.out.println("Account 1's balance = "+bankAccount1.getBalance());
      System.out.println("Account 2's balance = "+bankAccount2.getBalance());
      System.out.println("[ After Deposit ]");
      System.out.println("[Deposit : 20.50] Account 1's balance = "+bankAccount1.deposit(20.50));
      System.out.println("[Deposit : 30.25] Account 2's balance = "+bankAccount2.deposit(30.25));
      ...
      System.out.println("[Withdraw : 11.75] Account 1's balance = "+bankAccount2.withdraw(11.75));
      System.out.println("[Withdraw : 5] Account 2's balance = "+bankAccount1.withdraw(5));
      
      //Transfer
      System.out.println("[ Before transfer ]");
      System.out.println("Account 1's balance = "+bankAccount1.getBalance());
      System.out.println("Account 2's balance = "+bankAccount2.getBalance());
      bankAccount1.transfer(10, bankAccount2);
      System.out.println("[ After transfer [ account 1 transfer 10 to account 2 ] ]");
      System.out.println("Account 1's balance = "+bankAccount1.getBalance());
      System.out.println("Account 2's balance = "+bankAccount2.getBalance());
   }
}
